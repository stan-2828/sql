...
/* 1. ltrim, rtrim, trim*/
SELECT
LTRIM('        STAN WONG         ') as [ltrim]
,RTRIM('        STAN WONG         ') as [rtrim]
,TRIM('        STAN WONG         ') as [trim]

/* 2. replace*/
,REPLACE('STAN WONG','A','') as [not_my_name]
,customer_first_name
,REPLACE(customer_first_name,'a','') as new_customer_names
,REPLACE(REPLACE(customer_first_name,'A',''),'e','') as new_customer_names
,REPLACE(customer_first_name,'A','') as new_customer_names
