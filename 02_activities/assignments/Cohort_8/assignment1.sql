...
/*****
- Alternatively, can select each column in the table if known
SELECT 
customer_id
,customer_first_name
,customer_last_name
...
SELECT 
vendor_id
,COUNT(booth_number) as num_times_booth_rented
...
DROP TABLE IF EXISTS temp.new_vendor; -- if table exists, delete it, otherwise do NOTHING

CREATE TABLE temp.new_vendor AS -- make the temp TABLE
SELECT *
FROM vendor;
